...
// Добавляет команду "Создать на основании" в документы.
//
// Параметры:
...
// Устанавливает свойство ПриДобавленииКомандПечати в Истина
//
// Параметры:
